...
class ConstraintCorner2D: public ConstraintSparse<3,2,1,2,1>
{
	public:
		...
		ConstraintCorner2D(FeatureBasePtr _ftr_ptr, std::shared_ptr<LandmarkCorner2D> _lmk_ptr, bool _apply_loss_function = false, ConstraintStatus _status = CTR_ACTIVE) :
