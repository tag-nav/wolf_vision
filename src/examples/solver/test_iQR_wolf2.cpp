...
int main(int argc, char *argv[])
{
    ...
    SensorLaser2D laser_1_sensor(new StateBlock(laser_1_pose.head(2)), new StateBlock(laser_1_pose.tail(1)), laserscanutils::LaserScanParams({Constants::PI/2,-Constants::PI/2, -Constants::PI/720,0.01,0.2,100,0.01,0.01}));
    SensorLaser2D laser_2_sensor(new StateBlock(laser_2_pose.head(2)), new StateBlock(laser_2_pose.tail(1)), laserscanutils::LaserScanParams({Constants::PI/2,-Constants::PI/2, -Constants::PI/720,0.01,0.2,100,0.01,0.01}));
