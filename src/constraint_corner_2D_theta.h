...
class ConstraintCorner2DTheta: public ConstraintSparse<3,2,1,2,1>
{
	...
	public:
		...
		ConstraintCorner2DTheta(const FeatureCorner2DPtr& _ftr_ptr, const LandmarkCorner2DPtr& _lmk_ptr,  WolfScalar* _robotPPtr, WolfScalar* _robotOPtr, WolfScalar* _landmarkPPtr, WolfScalar* _landmarkOPtr) :
		...
		ConstraintCorner2DTheta(const FeatureCorner2DPtr& _ftr_ptr, const LandmarkCorner2DPtr& _lmk_ptr, const StateBaseShPtr& _robotPPtr, const StateBaseShPtr& _robotOPtr, const StateBaseShPtr& _landmarkPPtr, const StateBaseShPtr& _landmarkOPtr) :
		...
		{
			// Mapping
			Eigen::Map<Eigen::Matrix<T,2,1>> relative_landmark_position(_landmarkP);
