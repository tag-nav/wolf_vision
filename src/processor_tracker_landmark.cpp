...
ProcessorTrackerLandmark::ProcessorTrackerLandmark(ProcessorType _tp, std::string _type, const unsigned int& _max_new_features, const Scalar& _time_tolerance) :
