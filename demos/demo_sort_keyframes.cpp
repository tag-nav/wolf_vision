...
int main()
{
    ...
    problem_ptr->emplaceFrame(NON_ESTIMATED, Eigen::VectorXd::Zero(3), TimeStamp(0.1));
    FrameBasePtr frm2 = problem_ptr->emplaceFrame(NON_ESTIMATED, Eigen::VectorXd::Zero(3), TimeStamp(0.2));
    FrameBasePtr frm3 = problem_ptr->emplaceFrame(NON_ESTIMATED, Eigen::VectorXd::Zero(3), TimeStamp(0.3));
    problem_ptr->emplaceFrame(NON_ESTIMATED, Eigen::VectorXd::Zero(3), TimeStamp(0.4));
    FrameBasePtr frm5 = problem_ptr->emplaceFrame(NON_ESTIMATED, Eigen::VectorXd::Zero(3), TimeStamp(0.5));
    FrameBasePtr frm6 = problem_ptr->emplaceFrame(NON_ESTIMATED, Eigen::VectorXd::Zero(3), TimeStamp(0.6));
    ...
    FrameBasePtr frm7 = problem_ptr->emplaceFrame(KEY, Eigen::VectorXd::Zero(3), TimeStamp(0.7));
    std::cout << std::endl << "created Key Frame " << frm7->id() << " TS: " << 0.7 << std::endl;

    printFrames(problem_ptr);

    FrameBasePtr frm8 = problem_ptr->emplaceFrame(KEY, Eigen::VectorXd::Zero(3), TimeStamp(0.35));
